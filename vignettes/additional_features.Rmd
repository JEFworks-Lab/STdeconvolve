...
While technically the lowest perplexity computed is when K=8, perplexity appears to be relatively stable between K=7 and K=15. Additionally, we expect there to be more than 4 cell-types and thus K should be greater than 4 (based on "knee" metric).
