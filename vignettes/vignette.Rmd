...
matrix. We can interpret this `beta` matrix as a pseudobulk expression for that deconvolved cell-type. We can use these transcriptional profiles to compare to known cell-type
...
the transcriptional profiles of cell-type 2.
