...
```
We observe that cell type 19 correlates strongly with transcriptional communities 10 and 11. Let's observe their spatial locations. 
```{r, fig.height=5, fig.width=5}
vizTopic(deconProp, pos, 19, plotTitle = "cell type 19")

vizTopic(com_proxyTheta, pos, 10, plotTitle = "cluster 10")
