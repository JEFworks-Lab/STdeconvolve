...
First we compare the highly upregulated genes (>2) in transcriptional communities 18 and 19. 
1141 genes are upregulated in community 18 and 587 genes are upregulated in community 19. 221 of these genes are common between both communities. 

110 genes are upregulated in cell type 11. 42 of these genes are shared with both community 18 and 19. 
```{r}
celltype <- c(11)
...
length(Reduce(intersect, append(cell_upreg, community_upreg)))
```
