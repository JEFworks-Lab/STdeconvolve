...
ggplot2::ggplot(data = dat) +
  ...
  # ggplot2::guides(color = guide_colourbar(nbin = 10, raster = F, direction = "horizontal", barwidth = 20, barheight = 0.8)) +
  ggplot2::coord_fixed()
ggplot2::ggsave(filename = paste0("0_76cts_135genes_gt_txn_profile_corr_heatmap.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
ggplot2::ggplot(data = dat) +
  ...
  ggplot2::theme(axis.text.x=element_text(angle=-90, size=5),
                ...
                panel.background=element_blank()) +
  ggplot2::coord_fixed()
ggplot2::ggsave(filename = paste0("0_100um_76cts_135genes_txn_corr_heatmap.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
ggplot2::ggplot(data = dat) +
  ...
  ggplot2::theme(axis.text.x=element_text(angle=-90, size=5),
                ...
                panel.background=element_blank()) +
  ggplot2::coord_fixed()
ggplot2::ggsave(filename = paste0("0_100um_76cts_prop_corr_heatmap_txn_ordered_after_filtering.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
ggplot2::ggplot(data = dat) +
  ...
  ggplot2::theme(axis.text.x=element_text(angle=-90, size=5),
                ...
                panel.background=element_blank()) +
  ggplot2::coord_fixed()
ggplot2::ggsave(filename = paste0("0_100um_76cts_135genes_prop_corr_heatmap_after_filtering.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
ggplot2::ggplot(data = dat3, aes(x=Comparison, y=Correlation)) +
  ggplot2::geom_violin(trim=TRUE, fill="gray") +
  ggplot2::geom_boxplot(width=0.21) +
  ggplot2::geom_jitter(width = 0.2) +
  ggplot2::ylim(c(-1,1)) +
  ggplot2::scale_fill_grey() +
  ggplot2::labs(title = "Deconvolved and ground truth cell-type correlations, between pairs\n(100 micron pixels, 76 cell-types)",
                ...
                y = "Correlation") +
  ggplot2::theme_classic()
ggplot2::ggsave(filename = paste0("0_100um_76cts_135genes_heatmap_daig_corrs_after_filtering.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 2.5,
