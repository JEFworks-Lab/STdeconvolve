...
ks <- c(ks, seq(from = 25, to = 75, by = 10))
...
# pdf(file = paste0(fig_path, "Fig1_B-1_FN7_lda_fit.pdf"))
FN7_LDAs_2to20 <- fitLDA(counts = as.matrix(simFN7$sim),
                   Ks = ks,
                   testSize = NULL,
...
for(ix in names(simBregmasFN7)[1]){
  ...
  p1 <- vizAllTopics(theta = m,
                     ...
                     plotTitle = ix)
  print(p1)
  ggplot2::ggsave(filename = paste0("0_8cts_STdev_bregma_", ix, ".png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
plts1_grid
ggplot2::ggsave(filename = paste0("0_100um_8cts_separateCts_AllBregmas.png"),
                plot = plts1_grid,
                device = "png",
                path = fig_path,
                scale = 1,
...
plts2_grid
ggplot2::ggsave(filename = paste0("0_100um_8cts_grid_AllBregmas.png"),
                plot = plts2_grid,
                device = "png",
                path = fig_path,
                scale = 1,
...
plts3_grid
ggplot2::ggsave(filename = paste0("0_100um_8cts_simST_AllBregmas.png"),
                plot = plts3_grid,
                device = "png",
                path = fig_path,
                scale = 1,
...
plts4_grid
ggplot2::ggsave(filename = paste0("0_100um_8cts_STdeconvolve_AllBregmas.png"),
                plot = plts4_grid,
                device = "png",
                path = fig_path,
                scale = 1,
...
ggplot2::ggplot(data = dat) +
  ...
  ggplot2::theme(axis.text.x=element_text(angle=-90, size=10),
                 ...
                 panel.background=element_blank()) +
  ggplot2::coord_fixed()
ggplot2::ggsave(filename = paste0("0_100um_8cts_txn_corr_heatmap.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
ggplot2::ggplot(data = dat) +
  ...
  ggplot2::theme(axis.text.x=element_text(angle=-90, size=10),
                 ...
                 panel.background=element_blank()) +
  ggplot2::coord_fixed()
ggplot2::ggsave(filename = paste0("0_100um_8cts_prop_corr_heatmap_txn_ordered_after_filtering.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
ggplot2::ggplot(data = dat) +
  ...
  ggplot2::theme(axis.text.x=element_text(angle=-90, size=10),
                 ...
                 panel.background=element_blank()) +
  ggplot2::coord_fixed()
ggplot2::ggsave(filename = paste0("0_100um_8cts_prop_corr_heatmap_after_filtering.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
ggplot2::ggplot(data = dat3, aes(x=Comparison, y=Correlation)) +
  ...
  ggplot2::theme(axis.text.x=element_text(size=15),
                 ...
                 axis.title.x=element_blank(),
                 plot.title=element_text(size=15))
ggplot2::ggsave(filename = paste0("0_100um_8cts_heatmap_daig_corrs_after_filtering.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 3,
...
ggplot2::ggplot(data = summary_df) +
        ...
        ggplot2::theme(axis.text.x=element_text(size=15),
                       ...
                       plot.title=element_text(size=15))
ggplot2::ggsave(filename = paste0("0_100um_8cts_gene_ranks_hex.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 4,
