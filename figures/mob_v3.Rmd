...
# Plot
pdf(file = paste0(fig_path, "3_MOB_rep8_txn_clust_tsne.pdf"))
...
ggplot2::ggsave(filename = paste0("3_MOB_8_txn_grouped_pixels.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
dat <- data.frame(K = as.double(names(mobLDAs$perplexities)),
                  rareCts = mobLDAs$numRare,
                  perplexity = mobLDAs$perplexities,
                  rareCtsAdj = scale0_1(mobLDAs$numRare),
                  perplexAdj = scale0_1(mobLDAs$perplexities))
...
ggplot2::ggplot(dat, aes(x=K)) +
  ggplot2::geom_line(aes(y=rareCtsAdj), col="blue", lwd = 2) +
  ggplot2::geom_line(aes(y=perplexAdj), col="red", lwd = 2) +
  ggplot2::scale_y_continuous(name="# cell-types with mean proportion < 5%", breaks = prim_ax_breaks, labels = prim_ax_labs,
...
ggplot2::ggsave(filename = paste0("3_MOB_rep8_lda_fitting_lineplot.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
pdf(file = paste0(fig_path, "3_MOB_k12_vs_txn_corr_heatmap.pdf"), width = 8, height = 4)
gplots::heatmap.2(x = corMtx,
                  density.info = "none",
                  trace = "none",
                  col = correlation_palette,
...
plt <- vizAllTopics(theta = m,
                     ...
                     lwd = 0.3,
                     showLegend = TRUE,
                     plotTitle = "MOB rep 8, 12 deconvolved cell-types")

plt <- plt + guides(fill=guide_legend(ncol=2))
print(plt)
ggplot2::ggsave(filename = paste0("3_MOB_k12_pixels.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
for(i in c(3,4,5,7,11,12)){
  ...
  plt <- vizAllTopics(theta = m_,
                     ...
                     plotTitle = i)
  print(plt)
  # ggplot2::ggsave(filename = paste0("3_MOB_k12_pixels_ct11_innerCore.png"),
  #          device = "png",
  #          path = fig_path,
  #          scale = 1.5,
  #          width = 5,
...
plts_grid1
ggplot2::ggsave(filename = paste0("3_MOB_k12_ct7_top4_log2fc_markers_gexp_counts.png"),
         device = "png",
         plot = plts_grid1,
         path = fig_path,
         scale = 1.5,
...
gplots::heatmap.2(x = corMtx_paired[hc_$order,], # rearrange rows based on ct clustering
                  ...
                  # lhei = c(1,3),
                  margins = c(5,10))
pdf(file = paste0(fig_path, "3_MOB_k12_vs_SL_paired_corr_heatmap.pdf"), width = 6, height = 4)
gplots::heatmap.2(x = corMtx_paired[hc_$order,], # rearrange rows based on ct clustering
                  Rowv = NA,
                  Colv = as.dendrogram(hc_), # dendrogram also rearranges columns just like the rows and thus pairing is maintained
                  density.info = "none",
...
gplots::heatmap.2(x = corMtx_paired[hc_$order,], # rearrange rows based on ct clustering
                  ...
                  # lhei = c(1,3),
                  margins = c(5,10))
pdf(file = paste0(fig_path, "3_MOB_rctd_vs_SL_paired_corr_heatmap.pdf"), width = 6, height = 4)
gplots::heatmap.2(x = corMtx_paired[hc_$order,], # rearrange rows based on ct clustering
                  Rowv = NA,
                  Colv = as.dendrogram(hc_), # dendrogram also rearranges columns just like the rows and thus pairing is maintained
                  density.info = "none",
...
gplots::heatmap.2(x = corMtx_paired[hc_$order,], # rearrange rows based on ct clustering
                  ...
                  # lhei = c(1,3),
                  margins = c(5,10))
pdf(file = paste0(fig_path, "3_MOB_k12_vs_rctd_paired_corr_heatmap.pdf"), width = 6, height = 4)
gplots::heatmap.2(x = corMtx_paired[hc_$order,], # rearrange rows based on ct clustering
                  Rowv = NA,
                  Colv = as.dendrogram(hc_), # dendrogram also rearranges columns just like the rows and thus pairing is maintained
                  density.info = "none",
...
ggplot2::ggsave(filename = paste0("3_correlations_between_methods_boxplots.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
ggplot(data = dat, aes(x = reorder(group, group), y = value, color = color)) +
  ...
  theme(axis.text.x = element_text(angle = 0, size = 11),
        ...
        plot.title = element_text(size=15, face=NULL),
        legend.position = "none")
ggsave(filename = "3_N2_pixel_proportions_sl_rctd_noOEC_scatter.png",
       device = "png",
       path = fig_path,
       scale = 1.5,
       width = 3.5,
...
plts_grid
ggplot2::ggsave(filename = paste0("3_MOB_sl_rctd_noOECs_N2_pixels.png"),
         device = "png",
         plot = plts_grid,
         path = fig_path,
         scale = 1.5,
...
plts_grid
ggplot2::ggsave(filename = paste0("3_MOB_sl_rctd_cortex_VLMC_pixels.png"),
         device = "png",
         plot = plts_grid,
         path = fig_path,
         scale = 1.5,
...
pos <- mobCorpus$pos
counts <- mOB$countsCPM ## CPM normalized counts
...
plts_grid1
ggplot2::ggsave(filename = paste0("3_VLMC_top_marker_genes_cpm.png"),
         device = "png",
         plot = plts_grid1,
         path = fig_path,
         scale = 1.5,
...
ggplot2::ggsave(filename = paste0("3_MOB_k12_ct8_txnProfile_barplot.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
plts_grid1
ggplot2::ggsave(filename = paste0("3_OEC1_top_marker_genes_cpm.png"),
         device = "png",
         plot = plts_grid1,
         path = fig_path,
         scale = 1.5,
...
ggplot2::ggplot(data = dat) +
  ...
  ggplot2::theme(axis.text.x=element_text(angle=-90, size=8),
                ...
                panel.background=element_blank()) +
  ggplot2::coord_fixed()
ggplot2::ggsave(filename = paste0("3_mob_k12_rep8_rep2_txn_corr_heatmap.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
ggplot2::ggplot(data = dat) +
  ...
  ggplot2::theme(axis.text.x=element_text(angle=-90, size=8),
                ...
                panel.background=element_blank()) +
  ggplot2::coord_fixed()
ggplot2::ggsave(filename = paste0("3_mob_k12_rep8_rep12_txn_corr_heatmap.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
ggplot2::ggplot(data = dat) +
  ...
  ggplot2::theme(axis.text.x=element_text(angle=-90, size=8),
                ...
                panel.background=element_blank()) +
  ggplot2::coord_fixed()
ggplot2::ggsave(filename = paste0("3_mob_k12_rep8_rep5_txn_corr_heatmap.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
...
ggplot(data = reshape2::melt(plyr::ldply(cor_mob_summary, rbind)), 
  ...
  theme(axis.text.x = element_text(angle = 0, size = 12),
        ...
        plot.title = element_text(size=15, face=NULL),
        legend.position = "none")
ggplot2::ggsave(filename = paste0("3_correlations_between_mob_reps_k12_boxplots.png"),
         device = "png",
         path = fig_path,
         scale = 1.5,
         width = 5,
